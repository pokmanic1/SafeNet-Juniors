    ...
    if (item.statut === 1) {
        if (item.incercari === -1) {
            ...
            <div class="card-total overflow-hidden relative w-full max-w-[800px] flex items-center justify-center" style="height:80px">
                ...
                <!-- -------- -->
                <div
                    class="card-jos border-[1px] border-gray-500 flex overflow-hidden bg-[#EEEEEE] w-full max-w-[800px] h-[250px] sm:h-[260px] md:h-[280px] lg:h-[300px] absolute top-0 left-0 z-0 rounded-[15px] sm:rounded-[25px] lg:rounded-[30px] p-[15px] sm:p-[20px] lg:p-[30px]" style="display:none">
                    <div class="w-[80%]">
